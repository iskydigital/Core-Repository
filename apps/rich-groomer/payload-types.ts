...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'api-calls': ApiCallsSelect<false> | ApiCallsSelect<true>;
...
export interface Tenant {
  id: number;
  name: string;
  saas_id: 'rich-groomer' | 'travel-saas';
  plan_tier: 'essential' | 'professional' | 'domination';
  stripe_customer_id?: string | null;
  status?: ('active' | 'inactive' | 'churned') | null;
  updatedAt: string;
  createdAt: string;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "api-calls".
 */
export interface ApiCall {
  ...
  outcome?: ('success' | 'fallback' | 'error') | null;
  metadata?:
    | {
        [k: string]: unknown;
      }
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'api-calls';
        value: number | ApiCall;
      } | null)
    | ({
        relationTo: 'suburbs';
        value: number | Suburb;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "api-calls_select".
 */
export interface ApiCallsSelect<T extends boolean = true> {
  client_id?: T;
  saas_id?: T;
  tenant_id?: T;
  provider?: T;
