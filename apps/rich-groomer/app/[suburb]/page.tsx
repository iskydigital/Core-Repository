import { getSuburbBySlug } from '@/lib/payload'
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mt-10 p-6 bg-amber-50 rounded-lg text-center">
        ...
        <a href="https://therichgroomer.com/book-online/" className="bg-amber-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-amber-600">Book Online</a>
      </div>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", mainEntity: doc.faqItems?.map((faq: any) => ({ "@type": "Question", name: faq.question, acceptedAnswer: { "@type": "Answer", text: faq.answer } })) }) }} />
    </main>
  )
}
